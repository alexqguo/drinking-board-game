...
var PokemonSelector$1 = PokemonSelector;
//# sourceMappingURL=PokemonSelector.js.map
console.info(`[pokemon-gen2] including web components ${PokemonSelector$1.name}`);
const starterNames$1 = {
    chikorita: 'chikorita',
    cyndaquil: 'cyndaquil',
    totodile: 'totodile',
};
...
if (w.drinking && false) {
    ...
    GameEvents.on(events.GAME_START, (next) => {
        ...
        pokemonSelector.setAttribute('starterNames', JSON.stringify(Object.values(starterNames$1)));
